...
window.PLS_CONFIG = {
  ...
  math: [
    ...
    { id: 'm4', name: '減法', sub: '減一位數', gen: 'subOne', icon: 'minus',
  ...
  english: [
    ...
    { id: 'e7', name: '聽音選單字', sub: 'cat·dog·sun', play: 'wpick', cs: 'lower', count: 8,
      toy: { rabbit: '玩具屋', hamster: '小機器人' }, toyArt: { rabbit: 'dollhouse', hamster: 'robot' } },
    { id: 'e8', name: '拼拼單字', sub: '三個字母', play: 'spell', cs: 'lower', count: 6,
